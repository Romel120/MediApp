...
import { SearchIcon, CalendarIcon, QuestionMarkCircleIcon, InformationCircleIcon } from "@heroicons/react/outline";
      ...
      <nav className="bg-background shadow-lg py-4 px-6 flex justify-between items-center fixed w-full top-0 z-20">
        ...
        <Link href="/find-doctors">
          <button className="text-text font-medium flex items-center hover:text-primary transition-colors duration-300">
            <SearchIcon className="h-5 w-5 mr-2" /> Find Doctor
          </button>
          </Link>
          ...
          <Link href="/about-us">
          <button className="text-text font-medium flex items-center hover:text-primary transition-colors duration-300">
            <InformationCircleIcon className="h-5 w-5 mr-2" /> About Us
          </button>
          </Link>
          <Link href="/choice">
